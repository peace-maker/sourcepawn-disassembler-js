...
export default class V1Disassembler {
    ...
    private static fillOpcodeList(): void {
        ...
        this.prepareOpcode(V1Opcode.PUSH5, V1Param.Address, V1Param.Address, V1Param.Address, V1Param.Address,
                           V1Param.Address);
        ...
        this.prepareOpcode(V1Opcode.PUSH5_C, V1Param.Constant, V1Param.Constant, V1Param.Constant, V1Param.Constant,
                           V1Param.Constant);
        ...
        this.prepareOpcode(V1Opcode.PUSH5_ADR, V1Param.Stack, V1Param.Stack, V1Param.Stack, V1Param.Stack,
                           V1Param.Stack);
