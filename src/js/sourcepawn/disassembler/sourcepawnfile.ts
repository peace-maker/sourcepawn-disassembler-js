...
export type finishedLoading = () => void;

export default class SourcePawnFile {
    public callbackFileLoaded: finishedLoading;
    ...
    public constructor(file: File, fileLoadedCallback: finishedLoading) {
        this.file = file;
        this.callbackFileLoaded = fileLoadedCallback;
            ...
            for (const section of this.header.sections) {
                switch (section.name) {
                    ...
                    case ".dbg.natives":
                        ...
                        break;
                    case ".dbg.symbols":
                        this.debugSymbols = new SmxLegacyDebugSymbolTable(this.header, section,
                                                                    this.debugInfo, this.debugNames);
                        break;
                    case ".dbg.methods":
